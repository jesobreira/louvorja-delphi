...
begin
  ...
  FHotButtonColor := BS_BTNACTIVECOLOR;
  TabStop := True;
end;

procedure TbsSkinCategoryButtons.OnMouseTimerEvent(Sender: TObject);
var
  P: TPoint;
begin
  GetCursorPos(P);
...
procedure TbsSkinCategoryButtons.CMSENCPaint(var Message: TMessage);
begin
...
procedure TbsSkinCategoryButtons.CMBENCPAINT;
begin
...
begin
  ...
  begin
    ...
    {$IFDEF VER200}
    InterfaceData := TbsBaseButtonItem(Source).InterfaceData;
    {$ENDIF}
  end
  else
