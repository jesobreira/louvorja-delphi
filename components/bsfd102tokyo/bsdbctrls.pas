...
var
  ...
  BtnHints: array[TbsNavigateBtn] of String = (BS_DBNAV_FIRST_HINT, BS_DBNAV_PRIOR_HINT,
    BS_DBNAV_NEXT_HINT, BS_DBNAV_LAST_HINT, BS_DBNAV_INSERT_HINT, BS_DBNAV_DELETE_HINT,
    BS_DBNAV_EDIT_HINT, BS_DBNAV_POST_HINT, BS_DBNAV_CANCEL_HINT, BS_DBNAV_REFRESH_HINT);
...
procedure TbsSkinDBNavigator.SetImageList(Value: TCustomImageList);
begin
  FImageList := Value;
           ...
           case Ord(i) of
             0:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_FIRST;
             ...
             1:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_PRIOR;
             ...
             2:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_NEXT;
             ...
             3:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_LAST;
             ...
             4:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_INSERT;
             ...
             5:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_DELETE;
             ...
             6:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_EDIT;
             ...
             7:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_POST;
             ...
             8:
              ...
              then
                ...
                Buttons[I].Caption := BS_DBNAV_CANCEL;
             ...
             9:
              ...
              then
               ...
               Buttons[I].Caption := BS_DBNAV_REFRESH;
           end;
       end;
    end
  else
...
begin
  ...
  R := Rect(2, 2, Width - 2 - FButtonWidth - 1, Height - 2);
  B.Canvas.TextRect(R, TX, TY, Text);
end;
...
begin
  ...
  then
    begin
      ...
      then
        begin
          if Pos({$IFDEF VER240_UP}FormatSettings.{$ENDIF}DecimalSeparator, FDataLink.Field.Text) <> 0
          then
            begin
...
begin
  ...
  begin
    if (FPanel.Controls[i] is TbsSkinDBCurrencyEdit)
    then
      begin
        if  TbsSkinDBCurrencyEdit(FPanel.Controls[i]).FDataLink.Field <> nil
        then
          S := TbsSkinDBCurrencyEdit(FPanel.Controls[i]).FDataLink.Field.DisplayText
        else
          S := TbsSkinDBCurrencyEdit(FPanel.Controls[i]).Text;
        TbsSkinCustomEdit(FPanel.Controls[i]).PaintSkinTo(C, FPanel.Controls[i].Left, FPanel.Controls[i].Top, S);
      end
    else
    if (FPanel.Controls[i] is TbsSkinDBCalcCurrencyEdit)
    then
      begin
        if  TbsSkinDBCalcCurrencyEdit(FPanel.Controls[i]).FDataLink.Field <> nil
        then
          S := TbsSkinDBCalcCurrencyEdit(FPanel.Controls[i]).FDataLink.Field.DisplayText
        else
          S := TbsSkinDBCalcCurrencyEdit(FPanel.Controls[i]).Text;
        TbsSkinCustomEdit(FPanel.Controls[i]).PaintSkinTo(C, FPanel.Controls[i].Left, FPanel.Controls[i].Top, S);
      end
    else
    if (FPanel.Controls[i] is TbsSkinDBEdit)
    then
      begin
        if TbsSkinDBEdit(FPanel.Controls[i]).FDataLink.Field <> nil
        then
          S := TbsSkinDBEdit(FPanel.Controls[i]).FDataLink.Field.DisplayText
        else
          S := TbsSkinCustomEdit(FPanel.Controls[i]).Text;
          TbsSkinCustomEdit(FPanel.Controls[i]).PaintSkinTo(C, FPanel.Controls[i].Left, FPanel.Controls[i].Top, S);
      end
    else
    if (FPanel.Controls[i] is TbsSkinDBCalcEdit)
    then
      begin
        if TbsSkinDBCalcEdit(FPanel.Controls[i]).FDataLink.Field <> nil
        then
    ...
    if (FPanel.Controls[i] is TbsSkinDBMRUComboBox)
    then
      begin
        if (TbsSkinDBMRUComboBox(FPanel.Controls[i]).FDataLink.Field <> nil)
        then
          S := TbsSkinDBMRUComboBox(FPanel.Controls[i]).FDataLink.Field.DisplayText
        else
          S := '';
        TbsSkinDBMRUComboBox(FPanel.Controls[i]).PaintSkinTo(C, FPanel.Controls[i].Left, FPanel.Controls[i].Top, S);
      end
    else
    if (FPanel.Controls[i] is TbsSkinDBCheckRadioBox)
    then
      begin
        if (TbsSkinDBCheckRadioBox(FPanel.Controls[i]).FDataLink.Field <> nil)
        then
