...
procedure TbsSkinOfficeListBox.EnableScrollTimer(Value: Integer);
begin
...
procedure TbsSkinOfficeListBox.StopScrollTimer;
begin
  if FTimerMode <> 0 then
  begin
    FTimerMode := 0;
...
procedure TbsSkinOfficeListBox.WMTimer;
begin
  inherited;
...
procedure TbsSkinOfficeListBox.SetAlternateRow(Value: Boolean);
begin
...
procedure TbsSkinOfficeListBox.SkinDrawItem(Index: Integer; Cnvs: TCanvas; AAlternateColor: Boolean);
var
...
procedure TbsSkinOfficeListBox.DefaultDrawItem(Index: Integer; Cnvs: TCanvas; AAlternateColor: Boolean);
var
  R, R1, CR: TRect;
  C, FC: TColor;
  TX, TY: Integer;
...
begin
  ...
  if FAlternateRow and AAlternateColor and not FItems[Index].Header and not FItems[Index].Active
  then
    begin
      Cnvs.Brush.Style := bsSolid;
      ...
      then
       ...
       then
        begin
          ...
          Frame3D(Cnvs, CR, clbtnShadow, clbtnShadow, 1);
          if Checked
          then
            DrawCheckImage(Cnvs, CR.Left + 2, CR.Top + 1, clBlack);
          Cnvs.Pen.Color := C;
        end;
  ...
  begin
    ...
    DrawSkinFocusRect(Cnvs, FItems[Index].ItemRect);
  end;   
  RestoreDC(Cnvs.Handle, SaveIndex);   
end;
...
function TbsSkinCustomOfficeComboBox.GetAlternateRow: Boolean;
begin
  Result := FListBox.AlternateRow;
end;

procedure TbsSkinCustomOfficeComboBox.SetAlternateRow(Value: Boolean);
begin
...
procedure TbsSkinHorzListBox.EnableScrollTimer(Value: Integer);
begin
  if FTimerMode = 0 then
  begin
    FTimerMode := Value;
...
procedure TbsSkinHorzListBox.StopScrollTimer;
begin
  if FTimerMode <> 0 then
  begin
    FTimerMode := 0;
...
procedure TbsSkinHorzListBox.WMTimer;
begin
  inherited;
  if Message.TimerID = 1 then
  begin
...
procedure TbsSkinPopupOfficeGallery.EnableScrollTimer(Value: Integer);
begin
  if FTimerMode = 0 then
  begin
    FTimerMode := Value;
...
procedure TbsSkinPopupOfficeGallery.StopScrollTimer;
begin
  if FTimerMode <> 0 then
  begin
    FTimerMode := 0;
...
procedure TbsSkinPopupOfficeGallery.WMTimer;
begin
  inherited;
  if Message.TimerID = 1 then
  begin
...
procedure TbsSkinOfficeGridView.EnableScrollTimer(Value: Integer);
begin
  if FTimerMode = 0 then
  begin
    FTimerMode := Value;
...
procedure TbsSkinOfficeGridView.StopScrollTimer;
begin
  if FTimerMode <> 0 then
  begin
    FTimerMode := 0;
...
procedure TbsSkinOfficeGridView.WMTimer;
begin
  inherited;
  if Message.TimerID = 1 then
  begin
