...
resourcestring
  ...
  BS_MSG_BTN_STRETCH_HINT = 'Fit Picture';
  ...
  BS_MSG_LV_LIST = 'List';
  BS_MSG_LV_THUMBNAILS = 'Thumbnails';
  BS_MSG_LV_BIGTHUMBNAILS = 'Big Thumbnails';
  BS_MSG_LV_VERYBIGTHUMBNAILS = 'Very Big Thumbnails';
