...
// (DO NOT EDIT: machine generated header) 'bsawebbrowser.pas' rev: 6.00
...
/*	virtual HRESULT __stdcall GetDropTarget(const _di_IDropTarget pDropTarget, _di_IDropTarget &ppDropTarget) = 0 ; */
	...
	virtual HRESULT __stdcall TranslateUrl(const unsigned dwTranslate, const wchar_t * pchURLIn, wchar_t * &ppchURLOut) = 0 ;
