...
{       Version 5.30                                                }
{                                                                   }
{       Copyright (c) 2005-2014 Almediadev                          }
{       ALL RIGHTS RESERVED                                         }
{                                                                   }
...
type
  ...
  public
    ...
    function CheckButtonColor(AState: TcxButtonState; ACheckState: TcxCheckBoxState): TColor;
...
function TcxbsaLookAndFeelPainter.CheckButtonColor(AState: TcxButtonState; ACheckState: TcxCheckBoxState): TColor;
begin
 if (DevExSkindata <> nil) and (not DevExSkindata.Empty) then begin
    case AState of
     cxbsHot, cxbsPressed :
      Result := DevExSkindata.SkinColors.cBtnFace
     else
...
procedure TcxbsaLookAndFeelPainter.DrawCheckBorder(ACanvas: TcxCanvas; R: TRect;  AState: TcxButtonState);
begin
