...
function TcxbsaLookAndFeelPainter.ButtonGroupBorderSizes(AButtonCount,
...
procedure TcxbsaLookAndFeelPainter.DrawButtonInGroup(ACanvas: TcxCanvas;
...
procedure TcxbsaLookAndFeelPainter.DrawButtonGroupBorder(ACanvas: TcxCanvas;
...
begin
  ...
  then
    begin
      if AInplace then
      AColor := DevExSkinData.SkinColors.cBtnText
      else
      if ASelected then
        AColor := DevExSkinData.SkinColors.cBtnHighLight
      else
        AColor := DevExSkinData.SkinColors.cBtnShadow;
