...
// (DO NOT EDIT: machine generated header) 'bsawebbrowser.pas' rev: 5.00
...
__interface INTERFACE_UUID("{BD3F23C0-D43E-11CF-893B-00AA00BDCE1A}") IDocHostUIHandler  : public IUnknown 
	
{
	
public:
	virtual HRESULT __stdcall ShowContextMenu(const unsigned dwID, const Windows::PPoint ppt, const _di_IUnknown 
		pcmdtReserved, const _di_IDispatch pdispReserved) = 0 ;
	virtual HRESULT __stdcall GetHostInfo(TDOCHOSTUIINFO &pInfo) = 0 ;
/*	virtual HRESULT __stdcall ShowUI(const unsigned dwID, const _di_IOleInPlaceActiveObject pActiveObject
		, const _di_IOleCommandTarget pCommandTarget, const _di_IOleInPlaceFrame pFrame, const _di_IOleInPlaceUIWindow
		pDoc) = 0 ;*/
	...
	virtual HRESULT __stdcall ResizeBorder(const Windows::PRect prcBorder, const _di_IOleInPlaceUIWindow 
		pUIWindow, const BOOL FrameWindow) = 0 ;
	virtual HRESULT __stdcall TranslateAccelerator(const Windows::PMsg lpMsg, const System::PGUID pguidCmdGroup
		, const unsigned nCmdID) = 0 ;
	virtual HRESULT __stdcall GetOptionKeyPath(wchar_t * &pchKey, const unsigned dw) = 0 ;
/*	virtual HRESULT __stdcall GetDropTarget(const _di_IDropTarget pDropTarget,  _di_IDropTarget
		&ppDropTarget) = 0 ;*/
	virtual HRESULT __stdcall GetExternal(/* out */ _di_IDispatch &ppDispatch) = 0 ;
	virtual HRESULT __stdcall TranslateUrl(const unsigned dwTranslate, const wchar_t * pchURLIn, wchar_t * 
		&ppchURLOut) = 0 ;
	virtual HRESULT __stdcall FilterDataObject(const _di_IDataObject pDO, /* out */ _di_IDataObject &ppDORet
		) = 0 ;
};
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TScrollWinControl(HWND ParentWindow) : Controls::TWinControl(
		ParentWindow) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	void __fastcall DoBeforeNavigate2(System::TObject* Sender, const _di_IDispatch pDisp, OleVariant &URL
		, OleVariant &Flags, OleVariant &TargetFrameName, OleVariant &PostData, OleVariant &Headers, Word 
		&Cancel);
	void __fastcall DoCommandStateChange(System::TObject* Sender, int Command, Word Enable);
	void __fastcall DoNavigateComplete2(System::TObject* Sender, const _di_IDispatch pDisp, OleVariant 
		&URL);
	void __fastcall DoDocumentComplete(System::TObject* Sender, const _di_IDispatch pDisp, OleVariant &
		URL);
...
public:
	...
	HRESULT __stdcall ShowContextMenu(const unsigned dwID, const Windows::PPoint ppt, const _di_IUnknown 
		pcmdtReserved, const _di_IDispatch pdispReserved);
	HRESULT __stdcall GetHostInfo(TDOCHOSTUIINFO &pInfo);
/*	HRESULT __stdcall ShowUI(const unsigned dwID, const _di_IOleInPlaceActiveObject pActiveObject, const
		_di_IOleCommandTarget pCommandTarget, const _di_IOleInPlaceFrame pFrame, const _di_IOleInPlaceUIWindow
		pDoc);*/
	...
	HRESULT __stdcall ResizeBorder(const Windows::PRect prcBorder, const _di_IOleInPlaceUIWindow pUIWindow
		, const BOOL fRameWindow);
	HRESULT __stdcall TranslateAccelerator(const Windows::PMsg lpMsg, const System::PGUID pguidCmdGroup
		, const unsigned nCmdID);
	HRESULT __stdcall GetOptionKeyPath(wchar_t * &pchKey, const unsigned dw);
/*	HRESULT __stdcall GetDropTarget(const _di_IDropTarget pDropTarget,  _di_IDropTarget &ppDropTarget
		);*/
	HRESULT __stdcall GetExternal(/* out */ _di_IDispatch &ppDispatch);
	HRESULT __stdcall TranslateUrl(const unsigned dwTranslate, const wchar_t * pchURLIn, wchar_t * &ppchURLOut
		);
...
__published:
	...
	__property Shdocvw::TWebBrowserProgressChange OnNewProgressChange = {read=FOnNewProgressChange, write=
		FOnNewProgressChange};
	__property Shdocvw::TWebBrowserNavigateComplete2 OnNewNavigateComplete2 = {read=FOnNewNavigateComplete2
		, write=FOnNewNavigateComplete2};
	__property Shdocvw::TWebBrowserBeforeNavigate2 OnNewBeforeNavigate2 = {read=FOnNewBeforeNavigate2, 
		write=FOnNewBeforeNavigate2};
	__property Shdocvw::TWebBrowserCommandStateChange OnNewCommandStateChange = {read=FOnNewCommandStateChange
		, write=FOnNewCommandStateChange};
	__property Shdocvw::TWebBrowserDocumentComplete OnNewDocumentComplete = {read=FOnNewDocumentComplete
		, write=FOnNewDocumentComplete};
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented inline __fastcall TbsaWebBrowser(HWND ParentWindow) : Shdocvw::TWebBrowser(
		ParentWindow) { }*/
	#pragma option pop
