...
procedure TbsSkinButtonGroup.CMSENCPaint(var Message: TMessage);
begin
...
procedure TbsSkinButtonGroup.CMBENCPAINT;
begin
...
begin
  ...
  PanelData := TbsDataSkinPanelControl(SkinData.CtrlList[SkinData.GetControlIndex(FSkinDataName)]);
...
begin
  ...
  if (FButtonsSkinDataName <> 'resizetoolbutton') and
...
begin
  ...
  begin
    ...
    if bsbdsDown in State then
    begin
      EdgeColor := BS_BTNFRAMECOLOR;
      Canvas.Brush.Color := BS_BTNDOWNCOLOR;
    ...
    begin
       EdgeColor := BS_BTNFRAMECOLOR;
      Canvas.Brush.Color := BS_BTNACTIVECOLOR;
      Canvas.Font.Color := clBtnText;
    end
    else
    ...
    begin
      EdgeColor := Darker(clBtnFace, 15);//clBtnShadow;
      Canvas.Brush.Color := clBtnFace;
      Canvas.Font.Color := clBtnText;
    end;
